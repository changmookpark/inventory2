...
__ALL__ = ['CollectorManager', 'CollectingManager', 'CollectorDB', 'FilterManager', 'PluginManager',
           'ScheduleManager', 'JobManager', 'SecretManager', 'RegionConfigManager', 'CloudServiceManager']
...
class CollectorManager(BaseManager):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.cloud_svc_mgr = self.locator.get_manager('CloudServiceManager')
    ...
    def collect(self, params):
        ...
        options['last_collected_at'] = utils.datetime_to_iso8601(collector_dict['last_collected_at'])
        options['offset_day'] = collector_dict.get('tags', {}).get('offset_day', 'None')
        options['interval'] = collector_dict.get('tags', {}).get('interval', 'None')

        #     query =
        #
        #     cloud_service_vos = self.cloud_svc_mgr.list_cloud_services(query, domain_id)
        #     print("============================ cloud_service_vos :", cloud_service_vos)
    ...
    def _update_last_collected_time(self, collector_id, domain_id):
        ...
        if collector_vo['tags']['offset_day']:
            params['tags'] = collector_vo['tags']
            params['tags']['offset_day'] = '0'
