...
class Performance(MongoModel):
    performance_id = StringField(max_length=40, generate_id='performance', unique=True)
    ...
    # metadata = DictField()
    # timestamp = DateTimeField(default=None, null=True)
    metric = StringField(max_length=255)
    unit = StringField(max_length=255)
    ...
    meta = {
        ...
        'indexes': [
            ...
            # 'state',
            # {
            #     "fields": ['domain_id', 'performance_id'],
            #     "name": "COMPOUND_INDEX_FOR_GC_1"
            # },
            # {
            #     "fields": ['domain_id', 'updated_at'],
            ...
            #                'reference.resource_id', 'account', 'performance_id'],
            ...
            # },
            # {
            #     "fields": ['domain_id', 'performance_id', 'project_id'],
    ...
    #         raise ERROR_RESOURCE_ALREADY_DELETED(resource_type='Performance', resource_id=self.performance_id)
    #
